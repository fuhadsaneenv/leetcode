<h2><a href="https://leetcode.com/problems/reverse-degree-of-a-string/?envType=problem-list-v2&envId=string">3811. Reverse Degree of a String</a></h2><h3>Easy</h3><hr><p>Given a string <code>s</code>, calculate its <strong>reverse degree</strong>.</p>
